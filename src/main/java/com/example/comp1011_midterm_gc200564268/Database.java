            ...
            while (resultSet.next()) {
                try {
                    ...
                    if (!isValidPhoneNumber(telephoneNum)) {
                        LOGGER.log(Level.WARNING, "Invalid Telephone Number: " + telephoneNum);
                        continue; // Skip this student if the phone number is invalid
                    }

                    Student student = new Student(studentNumber, firstName, lastName, telephoneNum, address, province, averageGrade, major);
